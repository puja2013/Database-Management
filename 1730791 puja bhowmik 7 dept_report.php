...
<body>
  ...
  <?php
    ...
    while ($result_semester = mysqli_fetch_array($fire_semester)) {
      ...
      $fire_department = mysqli_query($con, $sql_department);
      while ($result_department = mysqli_fetch_array($fire_department)) {
        $DepartmentName = '"'.$result_department['DepartmentName'].'"';
        ...
        while ($result_id = mysqli_fetch_array($fire_id)) {
          ...
          WHERE semester.SemesterName = '.$SemesterName." AND student.StudentID = ".$StudentID." AND department.DepartmentName = ".$DepartmentName;
