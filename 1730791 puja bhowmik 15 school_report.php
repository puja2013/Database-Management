  ...
  <div class="wrapper">
      <div class="sidebar">
        ...
        <ul>
          ...
          <li style="background-color: #594f8d;"><a href="dept_report.php"><i class="fas fa-project-diagram"></i>Dept Report</a></li>
    ...
    while ($result_semester = mysqli_fetch_array($fire_semester)) {
      ...
      while ($result_school = mysqli_fetch_array($fire_school)) {
        ...
        while ($result_id = mysqli_fetch_array($fire_id)) {
          ...
          WHERE semester.SemesterName = '.$SemesterName." AND student.StudentID = ".$StudentID." AND school.SchoolName = ".$SchoolName;
...
<script type="text/javascript">
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ['Semester', 'School of Computer Science and Engineering', 'School of Business', 'School of Environmental Science and Management','School of Economics'],
        <?php
          echo $barchartdata;
        ?>
      ]);
    var options = {
      chart: {
        title: 'School wise Student Peerformence',
