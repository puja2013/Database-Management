<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql= "INSERT INTO `table_gpa`(`StudentID`, `semester`, `gpa`) VALUES ('$id', '$semester', '$gpa')";
        ...
        <div class="card" style="background-color: #F2F2F2;">
            <div class="card-body">
                <form action="" method="post">
                    <legend>Students GPA input section</legend>
                    <hr>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="disabledTextInput" class="form-label">Select Semester:</label>
                    ...
                    <div class="mb-3">
                        <label for="disabledTextInput" class="form-label">Enter GPA:</label>
                        <input type="text" id="disabledTextInput" class="form-control" name="gpa"
